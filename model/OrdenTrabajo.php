<?php
	...
	class OrdenTrabajo{
		...
		public function guardarOrden($array = array()){
			...
			$analisis = "";                                                                                                                                                                                                                    
			$validar = $array["valid"];
			$id_orden_trabajo = $array["id_orden_trabajo"];
			$aplicacion = $array["aplicacion"];
			$actividad = $array["actividad"];
			$anunciante = $array["anunciante"];
