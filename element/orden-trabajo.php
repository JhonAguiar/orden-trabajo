						...
						<div class="vertical-two">
							...
							<div class="contenete-ver-five">
								<div class="container">
									...
									<div class="row">
										<div class="large-12 columns">
											<label for="exampleFileUpload" class="button">Subir Firma Comercial</label>
											<input type="file" id="exampleFileUpload" class="show-for-sr">falta
										</div>
										<div class="large-12 columns">
											<label for="exampleFileUpload" class="button">Subir Firma Servicio al cliente</label>
											<input type="file" id="exampleFileUpload" class="show-for-sr">falta
										</div>
										<div class="large-12 columns">
											<label for="exampleFileUpload" class="button">Subir Firma Operaciones</label>
											<input type="file" id="exampleFileUpload" class="show-for-sr">falta
										</div>
									</div>
								</div>
